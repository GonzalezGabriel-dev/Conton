...
<body>
    ...
    <section class="ini" id="conocenos">
    <div class="container" style="height: 100%;">
        <div class="row" style="height: 100%;">
            <div class="col-6 txt mx-auto">
                <h1 class="fw-bold pt-5" style="width: 70%;">Mayor seguridad y eficacia, cuidando a tus clientes y a tu negocio</h1>
            </div>
            <div class="col-6 centrar">
                <img src="./logo.png" width="100%" class="pt-4  bg-light " alt="">
            </div>
        </div>
    </div>
    </section>
    ...
    <div class="container">
        <div class="row padd">
            ...
            <div class="col centrar d-none d-lg-block pt-5">
                <img src="./fondo.jpg" class="img-fluid" style="border-radius: 50px;" alt="">
            </div>
        </div>
    </div>
    </section>
      ...
      <div class="container padd">
        <div class="row">
          ...
          <div class="col-md-4 site-animate d-none d-lg-block">
            ...
            <p class="text-black">
              Direccion: <br> Av Benito Juarez, #350 <br> Nuevo Casas Grandes, Chihuahua <br> <br>
              Telefono: <br> 636 694 65 44 <br> <br>
